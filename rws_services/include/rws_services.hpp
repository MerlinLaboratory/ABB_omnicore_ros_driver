...
#include "omnicore_interface/move_gripper_to.h"
#include <iostream>
...
public:
    ...
    bool MoveToSrv (omnicore_interface::move_gripper_to::Request &req, omnicore_interface::move_gripper_to::Response &res);
